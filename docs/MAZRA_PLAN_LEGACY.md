⚠️ **Historical reference only — superseded by [`MAZRA_HOSPITAL_PLAN.md`](./MAZRA_HOSPITAL_PLAN.md).**  
This document described the pre–Mazra Hospital injector architecture. Do not implement new work against it.
